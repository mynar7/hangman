var hangman = {
    ...
    endGame: function (str) {
        ...
        //enable define
        document.getElementById("define").removeAttribute("disabled");
        //disable skip
        ...
        //update scoreboard
        document.getElementById("score").innerHTML = "Wins: " + hangman.wins +"<br>Losses: " + hangman.losses;
    },
    ...
    drawGallows: function() {
        var x = hangman.remainingGuesses;
        document.getElementById("gallows").setAttribute("src", "./assets/images/gallows" + x +".png");
    },
